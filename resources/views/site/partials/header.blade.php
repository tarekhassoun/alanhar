                    ...
                    <div class="widgets-wrap d-flex justify-content-end">
                        <div class="widget-header">
                            <a href="{{ route('checkout.cart') }}" class="icontext">
                                ...
                                <div class="text-wrap link-green">
                        ...
                        @guest
                            <div class="widget-header">
                                <a href="{{ route('login') }}" class="ml-3 icontext">
                                    <div class="icon-wrap icon-xs btn-green round text-white"><i class="fa fa-user"></i></div>
                                    <div class="text-wrap link-green"><span>Login</span></div>
                                </a>
                            </div>
                            ...
                            <div class="widget-header">
                                <a href="{{ route('register') }}" class="ml-3 icontext">
                                    <div class="icon-wrap icon-xs btn-green round text-white"><i class="fa fa-user"></i></div>
                                    <div class="text-wrap link-green"><span>Register</span></div>
                                </a>
                            </div>
                        @else
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item dropdown">
                                    <a
                                        id="navbarDropdown"
                                        class="nav-link dropdown-toggle link-green"
                                        href="#"
                                        role="button"
